...
if(isset($_POST['submit'])){
    ...
    // Jika tidak ada kecocokan ditemukan, arahkan kembali ke halaman login
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <form class="user" action="login.php" method="POST">
                      ...
                      <hr />
                      <a href=".php" class="btn btn-google btn-user btn-block"> <i class="fab fa-google fa-fw"></i> Login with Google </a>
                      <a href="login.php" class="btn btn-facebook btn-user btn-block"> <i class="fab fa-facebook-f fa-fw"></i> Login with Facebook </a>
                    </form>
                    <hr />
                    <div class="text-center">
